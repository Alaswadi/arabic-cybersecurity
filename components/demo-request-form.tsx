...
export function DemoRequestForm() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      // Use the standard contact form API but with a predefined subject
      const requestData = {
        ...formData,
        subject: "عرض توضيحي" // Set the subject automatically
      }
      ...
      if (response.ok && data.success) {
        ...
        setSubmitStatus({
          type: "success",
          message: data.message || "تم إرسال طلب العرض التوضيحي بنجاح. سنتواصل معك قريبًا.",
        })
        ...
        setSubmitStatus({
          type: "error",
          message: data.message || "حدث خطأ أثناء إرسال الطلب. يرجى المحاولة مرة أخرى.",
        })
