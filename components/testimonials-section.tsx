...
export function TestimonialsSection() {
  const testimonials = [
    {
      content:
        "منصة فيش سيبراني غيرت طريقة تعامل فريقنا مع الأمن السيبراني. التدريب التفاعلي ساعد في رفع مستوى الوعي الأمني لدى الموظفين بشكل كبير.",
      author: "محمد العتيبي",
    ...
    {
      content:
        "بفضل خدمات فيش سيبراني، تمكنا من تحديد وإصلاح العديد من نقاط الضعف في أنظمتنا قبل أن يتم استغلالها. فريق الدعم الفني ممتاز ويستجيب بسرعة لاستفساراتنا.",
      author: "سارة الخالدي",
    ...
    {
      content:
        "نحن نستخدم منصة فيش سيبراني منذ أكثر من عام، وقد لاحظنا انخفاضًا كبيرًا في حوادث الأمن السيبراني. التقارير التحليلية المفصلة تساعدنا في اتخاذ قرارات أفضل.",
      author: "أحمد الشمري",
