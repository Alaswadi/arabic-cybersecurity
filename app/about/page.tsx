          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <div className="space-y-4 text-gray-700">
                ...
                <p>
                  بدأنا رحلتنا بفريق صغير من المتخصصين، وسرعان ما نمت الشركة لتصبح واحدة من الشركات الرائدة في مجال الأمن السيبراني في المنطقة، مع فريق يضم أكثر من 100 خبير متخصص.
                </p>
                <p>
                  نفخر اليوم بخدمة أكثر من 500 عميل من مختلف القطاعات، بما في ذلك المؤسسات المالية والحكومية والشركات الكبرى، ونسعى دائمًا لتطوير حلولنا لمواكبة التحديات الأمنية المتجددة.
                </p>
              </div>
            </div>
